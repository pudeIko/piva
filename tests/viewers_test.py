...
class TestViewers:
    ...
    def check_3Dv_axes_tab(self, qtbot: Any) -> None:
        ...
        assert self.up.tabs.currentIndex() is 2
        qtbot.wait(LONG_WT)
        qtbot.keyClicks(self.up.axes_energy_scale, 'kinetic')
        assert self.up.axes_energy_scale.currentIndex() is 1
        qtbot.wait(LONG_WT * 2)
        qtbot.keyClicks(self.up.axes_energy_scale, 'binding')
        assert self.up.axes_energy_scale.currentIndex() is 0
        qtbot.wait(LONG_WT * 2)
    ...
    def check_3Dv_orientate_tab(self, qtbot: Any) -> None:
        ...
        assert self.up.tabs.currentIndex() is 3
        qtbot.wait(LONG_WT)
    ...
    def check_3Dv_image_tab(self, qtbot: Any) -> None:
        ...
        assert self.up.tabs.currentIndex() is 1
        qtbot.wait(LONG_WT)
        ...
        assert self.up.image_normalize_along.currentIndex() is 2
        qtbot.wait(LONG_WT)
        qtbot.mouseClick(self.up.image_normalize, Qt.LeftButton)
    ...
    def check_2dv_image_tab(self, qtbot: Any) -> None:
        ...
        assert self.up_2dv.tabs.currentIndex() is 1
        qtbot.wait(LONG_WT)
    ...
    def check_2dv_normalization(self, qtbot: Any) -> None:
        ...
        assert self.up_2dv.image_normalize_along.currentIndex() is 1
        qtbot.wait(LONG_WT * 2)
        qtbot.mouseClick(self.up_2dv.image_normalize, Qt.LeftButton)
    ...
    def check_2dv_axes_tab(self, qtbot: Any) -> None:
        ...
        assert self.up_2dv.tabs.currentIndex() is 2
        qtbot.wait(LONG_WT)
        qtbot.keyClicks(self.up_2dv.axes_energy_scale, 'kinetic')
        assert self.up_2dv.axes_energy_scale.currentIndex() is 1
        qtbot.wait(LONG_WT * 2)
        qtbot.keyClicks(self.up_2dv.axes_energy_scale, 'binding')
        assert self.up_2dv.axes_energy_scale.currentIndex() is 0
        qtbot.wait(LONG_WT * 2)
        ...
        assert self.up_2dv.axes_slit_orient.currentIndex() is 1
        qtbot.wait(LONG_WT * 2)
    ...
    def check_2dv_file_tab(self, qtbot: Any) -> None:
        ...
        assert self.up_2dv.tabs.currentIndex() is 3
        qtbot.wait(LONG_WT)
    ...
    def check_mdc_fitter_ranges_and_fitting(self, qtbot: Any) -> None:
        ...
        assert self.mdc_viewer.tabs.currentIndex() is 1
        qtbot.wait(LONG_WT)
    ...
    def check_plotting_tool(self, qtbot: Any) -> None:
        ...
        assert self.plot_tool.tabs.currentIndex() is 1
        qtbot.wait(LONG_WT)
    ...
    def check_BZ_contour(self, qtbot: Any) -> None:
        ...
        assert self.up_3dv_conv.tabs.currentIndex() is 1
        qtbot.wait(LONG_WT * 2)
        qtbot.keyClick(self.up_3dv_conv.image_symmetry, Qt.Key_Up)
        qtbot.keyClick(self.up_3dv_conv.image_symmetry, Qt.Key_Up)
        assert self.up_3dv_conv.image_symmetry.value() is 6
        qtbot.wait(LONG_WT * 2)
